...
{
    /* 
     * 1. Voeg in het bestand Enums.cs een enum toe met de 
     *    naam 'Colors'. Je voorziet de waarden Green, Red, Blue,
     *    Pink en MaxValue. (Die laatste is geen kleur, maar zal 
     ...
     *    string omgezet kan worden via zijn naam.
     */
